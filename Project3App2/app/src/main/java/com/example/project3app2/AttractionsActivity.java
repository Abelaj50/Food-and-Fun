...
public class AttractionsActivity extends FragmentActivity {
    ...
    private final WebViewerFragment WebsiteFragment = new WebViewerFragment("A");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SiteName = getResources().getStringArray(R.array.AttractionArray);
        SiteWebsite = getResources().getStringArray(R.array.AttractionWebsites);
        ...
        fragmentTransaction.replace(R.id.titleFrag, new TitlesFragment("A"));
    ...
    /* This method will dynamically resize the Fragment views based on back stack changes. */
